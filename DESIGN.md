...
**Next up:**
- **Implement `specs/labour-allocation.md`** (TDD from the spec). This is the one blocking item: catchment cannot bind until it lands, and catchment is the heart of §2.2.
